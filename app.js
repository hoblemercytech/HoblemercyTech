/* ============================================================================
   HoblemercyTech Business Growth Assessment — app.js
   ============================================================================
   Table of contents:
...
function restoreDraft() {
  try {
    ...
    if (!payload || !payload.answers) return false;
...
async function handleSubmitAssessment() {
  ...
  try {
    ...
    showToast("Assessment submitted successfully! HoblemercyTech will review your answers and contact you with a personalised recommendation on how to get started.", "success");
    clearDraft();
    renderResultScreen();
    goToStep("result");
  } catch (err) {
...
function init() {
  ...
  if (hadDraft) {
    ...
    showToast("We restored your previous unfinished assessment.", "success");
  }
}
